...
<header>
 ...
 <main>
    ...
    <div class="col-md-6 col-lg-6 container-fluid ">
      ...
      <!-- <div class="sent-notification" style="color: white;"></div> -->
      <div class="container recieved" ><h4 style="font-family: 'Poppins', sans-serif;">Message Recieved</h4></div>
        <div class="row" >
...
<button type="submit" class="btn btn-outline-secondary submit-button" id="submit" onclick="sendEmail()" style="margin-top: 2%;background-color: red;color: white;" >Submit</button>
